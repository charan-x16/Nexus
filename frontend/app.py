...
st.markdown(
    '<div class="nexus-subtitle">Approve the plan, watch research gather, then read the final report.</div>',
    unsafe_allow_html=True,
)

with st.form("workflow_form", clear_on_submit=False):
    project_name = st.text_input("Project name", value="Research Brief")
